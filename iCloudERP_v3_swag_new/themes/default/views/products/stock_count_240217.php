		...
		function loadStorage(){			
			...
			if(poitems != null)
			{
				...
				$.each(poitems, function (i,e) {
						var qty = e.row.quantity;
						//v += "<tr><td class='center'><input type='checkbox' /></td><td class='center'>"+k+"</td><td>"+e.label+"</td><td class='center'>"+qty+"</td><td class='center'>"+e.row.real_unit_cost+"</td><td class='center'>"+e.row.price+"</td><td style='font-size:28px; font-weight:bold; color:red;' class='center'>"+e.row.qty+"</td></tr>";
						v += "<tr><td class='center'><input type='checkbox' /></td><td class='center'>"+k+"</td><td>"+e.label+"</td><td class='center'>"+qty+"</td><td style='font-size:28px; font-weight:bold; color:red;' class='center'>"+e.row.qty+"</td></tr>";
					k++;
				});			
				$(".tbody").html(v);
			}
		...
		$("document").ready(function(){
			...
			function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
				...
				$.each(arrData, function (i,e) {
					arr_data.Product_name = e.label;
					arr_data.Stock_in_hand = e.row.quantity;
					//arr_data.Unit_cost = e.row.real_unit_cost;
					//arr_data.Product_price = e.row.price;
					arr_data.Quantity_count = e.row.qty;
					///arr_data.push(qoh);
					result.push(arr_data);//=(qoh);
				});	
