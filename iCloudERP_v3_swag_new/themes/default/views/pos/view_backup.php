            ...
            <table class="table table-striped table-condensed receipt">
                ...
                <tfoot>
					...
					<tr>
						...
						<th class="text-right"><?= number_format(($inv->total + $inv->product_tax) * $exchange_rate->rate) . ' ៛'; ?></th>
					</tr>
...
<?php } ?>
    ...
    <!--<span class="pull-right col-xs-12">
        <a href="<?=base_url()?>sales/print_hch/<?=$sid?>" target="_blank" class="btn btn-block btn-primary" ><?= lang("print_hch_invoice"); ?></a>
    </span>
	<span class="pull-right col-xs-12">
        <a href="<?=base_url()?>sales/print_jewwel/<?=$sid?>" target="_blank" class="btn btn-block btn-primary" ><?= lang("print_jewwel_apartment_invoice"); ?></a>
    </span>
	<span class="pull-right col-xs-12">
