                        ...
                        <tr>
                            ...
                            if (!empty($sales)) {
                                foreach ($sales as $value) {
                                    ...
                                    $array[$value->date] = "<table class='table table-bordered table-hover table-striped table-condensed data' style='margin:0;'><tbody><tr><td>" . $this->lang->line("discount") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->discount) . "</td></tr><tr><td>" . $this->lang->line("shipping") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->shipping) . "</td></tr><tr><td>" . $this->lang->line("product_tax") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->tax1) . "</td></tr><tr><td>" . $this->lang->line("order_tax") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->tax2) . "</td></tr><tr><td>" . $this->lang->line("total") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->total - $refund->paid) . "</td></tr><tr><td>" . $this->lang->line("award_points") . "</td></tr><tr><td>" . intval($value->total / $this->Settings->each_sale)  . "</td></tr></tbody></table>";
                                }
