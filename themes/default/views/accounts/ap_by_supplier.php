            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="POData" cellpadding="0" cellspacing="0" border="0"
						...
						?>
                        <tr>
                            <th class="th_parent" colspan="10">Supplier: <?= $sup['supplierName'] ?></th>
                        </tr>
						<tr class="active">
						...
						?>
									<tr>
										...
										<td><?= (explode('/', $suppData->reference_no)[0]=='PO'?"Purchase":(explode('/', $suppData->reference_no)[0]=='PV'?"Payment":"Not Assigned")) ?></td>
						...
						?>
										<tr>
											...
											<td><?= (explode('/', $supPmt->reference_no)[0]=='PO'?"Purchase":(explode('/', $supPmt->reference_no)[0]=='PV'?"Payment":"Not Assigned")) ?></td>
											<td class="numeric"><?= $this->erp->formatMoney(0) ?></td>
											<td class="numeric"><?= $this->erp->formatMoney(0) ?></td>
											<td class="numeric"><?= $this->erp->formatMoney(abs($supPmt->amount)) ?></td>
											<td class="numeric"><?= $this->erp->formatMoney(0) ?></td>
											<td class="numeric"><?= $this->erp->formatMoney(0) ?></td>
											<td class="numeric"><?= $this->erp->formatMoney(abs($supPmt->amount)-$sub_balance) ?></td>
											<td><a style="color:#000 !important;">View</a></td>
										</tr>
						<?php
