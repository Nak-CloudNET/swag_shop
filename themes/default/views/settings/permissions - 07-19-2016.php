                    ...
                    if ($p->group_id != 1) {
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="sales-loan" class="checkbox"
                                            ...
                                            for="sales-loan"
                                            class="padding05"><?= lang('list_loans') ?></label>
                                    </td>
                                </tr>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
										<input type="checkbox" value="1" class="checkbox" id="overview_chart"  name="overview-chart" <?php echo $p->{'reports-index'} ? "checked" : ''; ?>><label 
											for="overview_chart" class="padding05"><?= lang("overview_chart")?></label>
										<input type="checkbox" value="1" class="checkbox" id="warehout_stock_chart"><label 
											for="warehout_stock_chart" class="padding05"><?= lang("warehout_stock_chart")?></label>
										<input type="checkbox" value="1" class="checkbox" id="category_stock_chart"><label 
											for="category_stock_chart" class="padding05"><?= lang("category_stock_chart")?></label>
										<input type="checkbox" value="1" class="checkbox" id="profit_chart"><label 
											for="profit_chart" class="padding05"><?= lang("profit_chart")?></label>
										<input type="checkbox" value="1" class="checkbox" id="cash_analysis_chart"><label 
											for="cash_analysis_chart" class="padding05"><?= lang("cash_analysis_chart")?></label>
										<input type="checkbox" value="1" class="checkbox" id="register_report"><label 
											for="register_report" class="padding05"><?= lang("register_report")?></label><br>
										...
										<input type="checkbox" value="1" class="checkbox" id="warehouse_report"><label 
											for="warehouse_report" class="padding05"><?= lang("warehouse_report")?></label>
										<input type="checkbox" value="1" class="checkbox" id="product_in_out"><label 
											for="product_in_out" class="padding05"><?= lang("product_in_out")?></label>
										<input type="checkbox" value="1" class="checkbox" id="monthly_product"><label 
											for="monthly_product" class="padding05"><?= lang("monthly_product")?></label><br>	
										<input type="checkbox" value="1" class="checkbox" id="daily_product"><label 
											for="daily_product" class="padding05"><?= lang("daily_product")?></label>
										<input type="checkbox" value="1" class="checkbox" id="supplier_product"><label 
											for="supplier_product" class="padding05"><?= lang("supplier_product")?></label>
										<input type="checkbox" value="1" class="checkbox" id="product_customer"><label 
											for="product_customer" class="padding05"><?= lang("product_customer")?></label>
										<input type="checkbox" value="1" class="checkbox" id="category_report"><label 
											for="category_report" class="padding05"><?= lang("category_report")?></label>
										<input type="checkbox" value="1" class="checkbox" id="categories_value_report"><label 
											for="categories_value_report" class="padding05"><?= lang("categories_value_report")?></label>
                                        <input type="checkbox" value="1" class="checkbox" id="daily_sales"
                                            ...
                                            for="daily_sales" class="padding05"><?= lang('daily_sales') ?></label><br>
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_profit_report"><label 
											for="sale_profit_report" class="padding05"><?= lang("sale_profit_report")?></label>
										<input type="checkbox" value="1" class="checkbox" id="sale_discount_report"><label 
											for="sale_discount_report" class="padding05"><?= lang("sale_discount_report")?></label>
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_by_delivery_person"><label 
											for="sale_by_delivery_person" class="padding05"><?= lang("sale_by_delivery_person")?></label>
                                        <input type="checkbox" value="1" class="checkbox" id="purchases"
                                               name="reports-purchases" <?php echo $p->{'reports-purchases'} ? "checked" : ''; ?>><label
                                            for="purchases" class="padding05"><?= lang('purchases') ?></label><br>
										<input type="checkbox" value="1" class="checkbox" id="daily_purchase"><label 
											for="daily_purchase" class="padding05"><?= lang("daily_purchase")?></label>
										<input type="checkbox" value="1" class="checkbox" id="monthly_purchase"><label 
											for="monthly_purchase" class="padding05"><?= lang("monthly_purchase")?></label>
										...
										<input type="checkbox" value="1" class="checkbox" id="suspend_report"><label 
											for="suspend_report" class="padding05"><?= lang("suspend_report")?></label>
										<input type="checkbox" value="1" class="checkbox" id="staff_report"><label 
											for="staff_report" class="padding05"><?= lang("staff_report")?></label>
										<input type="checkbox" value="1" class="checkbox" id="saleman_report"><label 
											for="saleman_report" class="padding05"><?= lang("saleman_report")?></label><br>
										<input type="checkbox" value="1" class="checkbox" id="project_report"><label 
											for="project_report" class="padding05"><?= lang("project_report")?></label>
										<!-- Profit Loss -->
										<input type="checkbox" value="1" class="checkbox" id="profit_loss"
                                               name="reports-profit_loss" <?php echo $p->{'reports-profit_loss'} ? "checked" : ''; ?>><label
                                            for="profit_loss" class="padding05"><?= lang('profit_and_loss') ?></label>
