...
<script>
    $(document).ready(function () {
		...
		"aoColumns": [{"bSortable": false, "mRender": checkbox},null,null,null,null,null,{"mRender":row_statusX},null, {"mRender": currencyFormat},{"bSortable": false},],
            ...
            {column_number: 4, filter_default_label: "[<?=lang('Employee');?>]", filter_type: "text", data: []},
    ...
    <div class="box-header">
		...
		<div class="box-icon">
            <ul class="btn-tasks">
				...
				<li class="dropdown">
                    <a href="<?= site_url('products/export_using_stock_to_excel'); ?>" id="xls" class="tip" title="<?= lang('download_xls') ?>">
