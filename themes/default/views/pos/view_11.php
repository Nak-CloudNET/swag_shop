...
<div id="wrapper">
    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            ?>
			<div>#138E0, St. 13. Sangkat Phsa kandal Phnom Penh<br/>Tel: 092/093/069 311 138 www.a-ycollection.com</div>
			...
			<table style="width: 100%;">				
					<tbody style="font-size: 14px;">						
						<tr style="text-align:center;">	
							...
							<td style="vertical-align:middle;text-align:left;">$1 = R 4100</td>
						...
						<tr style="text-align:center;">	
							...
							<td style="vertical-align:middle;text-align:left;"><?= $this->session->userdata('username') ?></td>
			...
			<table style="width: 100%; margin-top: 5px;">
				...
				<tr>
					...
					echo $sub_total-$inv->order_discount;
					?>
					</td>
				</tr>
				<?php
