            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tr>
						...
						<?php if ($Owner || $Admin || $GP['transfers-cost']) { ?>
                    ...
                    if ($this->Settings->tax1) {
                        ...
                        <tr>
							...
							<?php if (!$Owner || !$Admin || !$GP['transfers-subtotal']) { ?>
								<td style="text-align:right; padding-right:10px;"><?= $this->erp->formatQuantity($total_qty); ?>
							<?php } ?>
						...
						<?php if($Owner || $Admin || $transfer->shipping >0){ ?>
							<tr>
